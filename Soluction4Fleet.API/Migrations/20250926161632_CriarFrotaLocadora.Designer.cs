...
namespace Soluction4Fleet.API.Migrations
{
    ...
    [Migration("20250926161632_CriarFrotaLocadora")]
    partial class CriarFrotaLocadora
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Soluction4Fleet.API.Domain.Entities.FrotaLocadora", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("FrotaLocadora", (string)null);
                });
            ...
            modelBuilder.Entity("Soluction4Fleet.API.Domain.Entities.FrotaLocadora", b =>
                {
                    b.HasOne("Soluction4Fleet.API.Domain.Entities.Locadora", "Locadora")
                        .WithMany("FrotaLocadoras")
                        .HasForeignKey("LocadoraId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Soluction4Fleet.API.Domain.Entities.Veiculo", "Veiculo")
                        .WithMany("FrotaLocadoras")
